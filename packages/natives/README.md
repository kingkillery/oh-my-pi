...
```typescript
import { grep, find, encodeSixel } from "@pk-nerdsaver-ai/pi-natives";
...
`@pk-nerdsaver-ai/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @pk-nerdsaver-ai/pi-natives-<platform>-<arch>
