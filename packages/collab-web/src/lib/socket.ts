 ...
 * of `@pk-nerdsaver-ai/pi-coding-agent/src/collab/relay-client.ts` semantics).
 *
...
import type { GuestFrame, HostFrame, RelayControlMessage } from "@pk-nerdsaver-ai/pi-wire";
