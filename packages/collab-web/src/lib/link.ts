 ...
 * link/envelope half of `@pk-nerdsaver-ai/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@pk-nerdsaver-ai/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@pk-nerdsaver-ai/pi-wire";
