...
import { loadCapability, setDisabledProviders } from "@pk-nerdsaver-ai/pi-coding-agent/capability";
import type { ContextFile } from "@pk-nerdsaver-ai/pi-coding-agent/capability/context-file";
import { clearCache } from "@pk-nerdsaver-ai/pi-coding-agent/capability/fs";
import type { Instruction } from "@pk-nerdsaver-ai/pi-coding-agent/capability/instruction";
...
import "@pk-nerdsaver-ai/pi-coding-agent/capability/rule";
