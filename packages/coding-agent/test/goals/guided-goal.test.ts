...
import * as core from "@pk-nerdsaver-ai/pi-agent-core";
...
import { runGuidedGoalTurn } from "@pk-nerdsaver-ai/pi-coding-agent/goals/guided-setup";
...
import { AgentSession as RealAgentSession } from "@pk-nerdsaver-ai/pi-coding-agent/session/agent-session";
