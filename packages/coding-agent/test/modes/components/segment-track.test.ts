...
import {
	...
	type TrackSegment,
} from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/segment-track";
import { initTheme, type ThemeColor, theme } from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/theme";
