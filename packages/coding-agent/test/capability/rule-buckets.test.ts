...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@pk-nerdsaver-ai/pi-coding-agent/capability/rule";
import { bucketRules } from "@pk-nerdsaver-ai/pi-coding-agent/capability/rule-buckets";
