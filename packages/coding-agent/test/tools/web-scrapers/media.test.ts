...
import { handleHuggingFace } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/vimeo";
