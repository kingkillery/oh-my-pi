...
import { handleCheatSh } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/tldr";
