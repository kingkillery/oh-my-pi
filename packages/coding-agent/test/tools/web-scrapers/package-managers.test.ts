...
import { handleAur } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/rubygems";
