...
import { handleArxiv } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/types";
