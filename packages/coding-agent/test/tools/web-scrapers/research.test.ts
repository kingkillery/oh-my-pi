...
import { handleBiorxiv } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/wikidata";
