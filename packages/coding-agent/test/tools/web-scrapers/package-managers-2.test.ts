...
import { handleChocolatey } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/terraform";
