...
import { handleArtifactHub } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@pk-nerdsaver-ai/pi-coding-agent/web/scrapers/discogs";
