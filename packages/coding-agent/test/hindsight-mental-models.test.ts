...
import type { BankScope } from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/bank";
import {
	type HindsightApi,
	HindsightApi as HindsightApiCtor,
	type MentalModelSummary,
} from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/client";
import {
...
} from "@pk-nerdsaver-ai/pi-coding-agent/hindsight/mental-models";
