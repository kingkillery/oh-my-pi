...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@pk-nerdsaver-ai/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@pk-nerdsaver-ai/pi-coding-agent/session/session-entries";
