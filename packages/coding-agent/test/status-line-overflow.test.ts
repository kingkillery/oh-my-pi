...
import type { StatusLineSegmentId } from "@pk-nerdsaver-ai/pi-coding-agent/config/settings-schema";
...
import { getSessionAccentAnsi, getSessionAccentHex } from "@pk-nerdsaver-ai/pi-coding-agent/utils/session-color";
