...
import * as skillsModule from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/skills";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@pk-nerdsaver-ai/pi-coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
...
describe("autoloadSkills in executor", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@pk-nerdsaver-ai/pi-coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
