...
import { renderSearchResult, type SearchRenderDetails } from "@pk-nerdsaver-ai/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@pk-nerdsaver-ai/pi-coding-agent/web/search/types";
