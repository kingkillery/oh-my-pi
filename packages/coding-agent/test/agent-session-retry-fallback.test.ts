...
import { type AssistantMessage, Effort, type Model, type ProviderSessionState } from "@pk-nerdsaver-ai/pi-ai";
...
import { parseModelPattern } from "@pk-nerdsaver-ai/pi-coding-agent/config/model-resolver";
