...
import { encodeTextSignatureV1 } from "@pk-nerdsaver-ai/pi-ai/providers/openai-shared";
import type { AssistantMessage, Model, ProviderPayload, Usage } from "@pk-nerdsaver-ai/pi-ai/types";
import { getBundledModel } from "@pk-nerdsaver-ai/pi-catalog/models";
import { buildSessionContext } from "@pk-nerdsaver-ai/pi-coding-agent/session/session-context";
import type {
	CompactionEntry,
	ModelChangeEntry,
	SessionEntry,
