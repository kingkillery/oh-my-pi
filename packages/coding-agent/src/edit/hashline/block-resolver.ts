 ...
 * primitive in `@pk-nerdsaver-ai/pi-natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@pk-nerdsaver-ai/hashline";
import { blockRangeAt } from "@pk-nerdsaver-ai/pi-natives";
