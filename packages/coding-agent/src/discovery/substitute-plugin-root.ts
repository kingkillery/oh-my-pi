/**
 * Recursively substitute ${CLAUDE_PLUGIN_ROOT}, ${OMP_PLUGIN_ROOT}, and
 * ${PLUGIN_ROOT} with the actual plugin root path in strings, arrays, and plain objects.
 */
...
export function substitutePluginRoot<T>(value: T, rootPath: string): T {
	if (typeof value === "string") {
		return value
			...
			.replaceAll(GENERIC_VAR, rootPath) as T;
	}
