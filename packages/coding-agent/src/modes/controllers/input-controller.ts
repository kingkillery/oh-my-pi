...
export class InputController {
	...
	setupKeyHandlers(): void {
		...
		for (const key of this.ctx.keybindings.getKeys("app.session.backgrounds")) {
			this.ctx.editor.setCustomKeyHandler(key, () => void this.ctx.showBackgroundInstanceSelector());
		}
		...
		// Double-tap left arrow on an empty editor: opens the session selector from the
