...
import type { AssistantMessage, ImageContent, Message, Model, UsageReport } from "@pk-nerdsaver-ai/pi-ai";
...
export class InteractiveMode implements InteractiveModeContext {
	...
	showBackgroundInstanceSelector(): Promise<void> {
		return this.#selectorController.showBackgroundInstanceSelector();
	}
	...
	handleNewBackgroundSession(query: string): Promise<void> {
		this.#btwController.dispose();
		this.#omfgController.dispose();
		this.resetObserverRegistry();
		return this.#selectorController.handleNewBackgroundSession(query);
	}
