...
This document covers execution/process/terminal primitives in `@pk-nerdsaver-ai/pi-natives`: `shell`, `pty`, `ps`, and `keys`, using the architecture terms from `docs/natives-architecture.md`.
